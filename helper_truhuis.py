...
from helper_brownie import get_address, get_mock

# hardhat default deployment addresses
...
def TRUHUIS():
    return {
        "hardhat": {
            "address_registry": {},
            "auction": {
                "owner": config["networks"]["hardhat"]["truhuis"],
                # "owner": get_address(_name="truhuis"),
            ...
            "citizen": {
                "nld": [
                    {  # 0
                        ...
                        "account": [config["networks"]["hardhat"]["citizen_nld_1"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"nld"],
                    },
                    {  # 1
                        ...
                        "account": [config["networks"]["hardhat"]["citizen_nld_2"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"nld"],
                    },
                    {  # 2
                        ...
                        "account": [config["networks"]["hardhat"]["citizen_nld_3"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"nld"],
                    },
                ],
                "usa": [
                    {  # 0
                        ...
                        "account": [config["networks"]["hardhat"]["citizen_usa_1"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"usa"],
                    },
                    {  # 1
                        ...
                        "account": [config["networks"]["hardhat"]["citizen_usa_2"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"usa"],
                    },
                    {  # 2
                        ...
                        "account": [config["networks"]["hardhat"]["citizen_usa_3"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"usa"],
                    },
                ],
        ...
        "kovan": {
            "address_registry": {},
            "auction": {
                "owner": config["networks"]["kovan"]["truhuis"],
                "commission": 250,  # e.g. 100 (1%); 1000 (10%)
            },
            "currency_registry": {
                "EURT": get_mock("truhuis", "currency_registry", "EURT"),
            ...
            "citizen": {
                "nld": [
                    {  # 0
                        ...
                        "date_of_birth": [142100, 21, 4, 2000],
                        "place_of_birth": [b"amsterdam", b"north holland", b"nld"],
                        "account": [config["networks"]["kovan"]["citizen_nld_1"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"nld"],
                    },
                    {  # 1
                        ...
                        "date_of_birth": [115609, 21, 4, 1994],
                        "place_of_birth": [b"utrecht", b"utrecht", b"nld"],
                        "account": [config["networks"]["kovan"]["citizen_nld_2"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"nld"],
                    },
                    {  # 2
                        ...
                        "date_of_birth": [212512, 9, 7, 1991],
                        "place_of_birth": [b"rotteram", b"south holland", b"nld"],
                        "account": [config["networks"]["kovan"]["citizen_nld_3"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"nld"],
                    },
                ],
                "usa": [
                    {  # 0
                        ...
                        "date_of_birth": [142100, 21, 4, 2000],
                        "place_of_birth": [b"salt lake city", b"utah", b"usa"],
                        "account": [config["networks"]["kovan"]["citizen_usa_1"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"usa"],
                    },
                    {  # 1
                        ...
                        "date_of_birth": [115609, 21, 4, 1994],
                        "place_of_birth": [b"albuquerque", b"new mexico", b"usa"],
                        "account": [config["networks"]["kovan"]["citizen_usa_2"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"usa"],
                    },
                    {  # 2
                        ...
                        "date_of_birth": [212512, 9, 7, 1991],
                        "place_of_birth": [b"san antonio", b"texas", b"usa"],
                        "account": [config["networks"]["kovan"]["citizen_usa_3"]],
                        "uri": ["ipfs://", "ipfs://"],
                        "citizenship": [b"usa"],
                    },
                ],
...
def ADDRESS_REGISTRY():
    return TRUHUIS()[f"{network.show_active()}"]["address_registry"]


def AUCTION():
    return TRUHUIS()[f"{network.show_active()}"]["auction"]


def CITIZEN():
    return TRUHUIS()[f"{network.show_active()}"]["citizen"]


def CITIZEN_NLD():
    return TRUHUIS()[f"{network.show_active()}"]["citizen"]["nld"]


def CITIZEN_USA():
    return TRUHUIS()[f"{network.show_active()}"]["citizen"]["usa"]


def CURRENCY_REGISTRY():
    return TRUHUIS()[f"{network.show_active()}"]["currency_registry"]


def CADASTRE():
    return TRUHUIS()[f"{network.show_active()}"]["cadastre"]


def MARKETPLACE():
    return TRUHUIS()[f"{network.show_active()}"]["marketplace"]


def STATE_GOVERNMENT():
    return TRUHUIS()[f"{network.show_active()}"]["state_government"]
