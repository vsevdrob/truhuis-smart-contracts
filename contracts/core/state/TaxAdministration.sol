...
import {TaxAdministrationStorage as Storage} from "./TaxAdministrationStorage.sol";
...
contract TaxAdministration is Ownable, ITaxAdministration, Storage {
    ...
    function updateTransferTax(uint256 _id, uint96 _tax) public override onlyOwner {
        _sTransferTaxById[_id] = _tax;
        emit TransferTaxUpdated(_id, _tax);
    }

    /// @inheritdoc ITaxAdministration
    function transferTax(address _buyer, uint256 _tokenId) public view override returns (uint96) {
